 ...
 * @Date: 2019-03-25 11:44:35 
 * @Module:招聘套餐
 * @Last Modified time: 2019-03-25 11:44:35 
 */
        ...
        return (
            <View style={{ backgroundColor: '#ebebeb', flex: 1 }}>
                ...
                <View style={{backgroundColor:'#fff',paddingTop:16.5,paddingBottom:16.5,flexDirection:'row'}}>
                    <TouchableOpacity
                    onPress={()=>this.props.navigation.navigate('Joborder')}
                    style={{width:'50%'}}>
                ...
                <TouchableOpacity
                onPress={()=>this.props.navigation.navigate('Buyalivecall')}
                style={{backgroundColor:'#fff',marginTop:11,padding:11}}>
                    <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
                        <View style={{flexDirection:'row',alignItems:'flex-start'}}>
                            <Image style={{width:66,height:66}} source={require('../../../assets/recruit/jobwork.png')}></Image>
                        ...
                        <View style={{borderWidth:1,borderColor:'#666',borderRadius:4.4,width:77,height:29,
                ...
                style={{backgroundColor:'#fff',marginTop:11,padding:11}}>
                    <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
                        <View style={{flexDirection:'row',alignItems:'flex-start'}}>
                            <Image style={{width:66,height:66}} source={require('../../../assets/recruit/foreman.png')}></Image>
                            <View style={{marginLeft:11}}>
                                <View style={{flexDirection:'row',alignItems:'center'}}>
                                    <Text style={{color:'#000',fontWeight:'700',fontSize:16.5}}>购买</Text>
                ...
                style={{backgroundColor:'#fff',marginTop:11,padding:11}}>
                    <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
                        <View style={{flexDirection:'row',alignItems:'flex-start'}}>
                            <Image style={{width:66,height:66}} source={require('../../../assets/recruit/worker.png')}></Image>
                            <View style={{marginLeft:11}}>
                                <View style={{flexDirection:'row',alignItems:'center'}}>
                                    <Text style={{color:'#000',fontWeight:'700',fontSize:16.5}}>购买</Text>
