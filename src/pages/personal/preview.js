                    ...
                    <View style={{
                        ...
                        <View style={{ paddingLeft: 22, paddingRight: 22, paddingBottom: 22, paddingTop: 22, flexDirection: 'row', alignItems: 'center' }}>
                            <View style={{ marginRight: 40 }}>
                                ...
                                <Text style={{ fontSize: 18.7, color: '#000', fontWeight: '400', textAlign: 'center' }}>沈桃林</Text>
                            </View>
                            <View>
                                <Text style={{ fontSize: 18.7, color: '#000', fontWeight: '400', textAlign: 'left', height: 24, marginBottom: 10 }}>男  汉族</Text>
