 ...
 * @Date: 2019-03-29 16:47:37 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2019-04-18 16:19:34
 * Module:工人/班组-品牌班组
 */
...
export default class hiriingrecord extends Component {
    ...
    componentDidMount() {
        this.getWorkTeam()// 品牌班组列表数据获取
    }
    getWorkTeam(e) {
        let { dataSource } = this.state
        fetchFun.load({
            url: 'v2/project/getForemanRecommendResume',
        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                <ListItem
                    ...
                    ListFooterComponent={() => <Footer ifLoadingMore={this.state.ifLoadingMore} />}//尾布局
        ...
        return (
            !this.props.ifLoadingMore ? (
                <View style={{ flex: 1, }}>
                    ...
                    <Text style={styles.font}>品牌班组数据为空</Text>
                </View>
            ) : false
        )
    }
...
class List extends React.Component {
    ...
    render() {
        ...
        return (
            <TouchableOpacity activeOpacity={.7} onPress={() => this.props.navigate.navigate('Personal_preview', { uid: item.uid, fromTo: 'yzlw', role_type: '2', grorbz: '1', nameTo: 'grorbz' })}>
                <View style={{
                    flexDirection: 'row',
                    alignItems: 'center',
                        ...
                        <View style={{ position: "relative" }}>
                            ...
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                                <View style={{
                                    ...
                                    borderRadius: 4.4, width: 49, height: 49, marginRight: 15,
                                    overFlow: 'hidden'
                                }}>
                                    <ImageCom
                                        ...
                                        {/* 地点 */}
                                        {
                                            item.current_addr ? (
                                                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                                    ...
                                                    <Text style={{ color: '#666', fontSize: 13.2, marginLeft: 5, marginRight: 15 }} >
                                                        {item.current_addr}
                                                    </Text>
                                                </View>
                                            ) : (false)
