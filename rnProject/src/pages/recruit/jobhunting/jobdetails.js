                    ...
                    <View style={styles.bg}>
                        ...
                        <View style={{ paddingTop: 9, paddingBottom: 9, }}>
                            ...
                            <View style={{
                                ...
                                flexDirection: 'row', flexWarp: 'warp'
                            }}>
                                <Text style={{ color: '#999', fontSize: 15.4, lineHeight: 25 }}>
                                    提示：此信息由平台用户提供，如果发现此信息不真实，请
                                    <Text style={{ color: '#4193df', fontSize: 15.4, fontWeight: '700' }}>立即举报</Text>
                                </Text>
                            </View>
                        </View>
                    </View>
                        ...
                        <View>
                            <View style={{ flexDirection: 'row', flexWarp: 'warp' }}>
                                <Text style={{ color: '#666', fontSize: 15.4 }}>加客服微信号
                                    <Text style={{ color: '#4193df', fontSize: 15.4, fontWeight: '700' }}>g918008</Text>
                                </Text>
                                <View style={{
                                    flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
                            ...
                            <Text style={{ color: '#666', fontSize: 15.4, lineHeight: 25 }}>
                                关注“吉工家”微信公众号接收新工作提醒
                                <Text style={{ color: '#4193df', fontSize: 15.4, fontWeight: '700' }}>如何关注</Text>
                            </Text>
                        </View>
                    </View>
                </ScrollView>
