...
export default class lookworker extends Component {
    ...
    clickaddress(obj) {
        ...
        this.state.addressone.map((item, key) => {
            if (item.key == obj.a) {
                GLOBAL.fbaddress.fboneName = item.name
            }
        })
        this.state.addresstwo.map((item, key) => {
            if (item.key == obj.b) {
                GLOBAL.fbaddress.fbtwoName = item.name
            }
        })
        GLOBAL.fbaddress.fbone = obj.a
        GLOBAL.fbaddress.fbtwo = obj.b
