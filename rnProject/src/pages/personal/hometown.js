...
export default class basic extends Component {
    ...
    render() {
        ...
        objAddress.addressthree = this.state.addressthree
        objAddress.onenum = this.state.clickaddressoneNum
        objAddress.twonum = this.state.clickaddresstwoNum
        objAddress.threenum = this.state.clickaddressthreeNum
        objAddress.jb = 'jxaddress'
        return (
    ...
    clickaddress(obj) {
        this.setState({
            ...
            clickaddressthreeNum: obj.c,
        })
        this.state.addressone.map((item, key) => {
            if (item.key == obj.a) {
                GLOBAL.editbasic.jxaddress.jxoneName = item.name
            }
        })
        this.state.addresstwo.map((item, key) => {
            if (item.key == obj.b) {
                GLOBAL.editbasic.jxaddress.jxtwoName = item.name
            }
        })
        this.state.addressthree.map((item, key) => {
            if (item.key == obj.c) {
                GLOBAL.editbasic.jxaddress.jxthreeName = item.name
            }
        })
        GLOBAL.editbasic.jxaddress.jxone = obj.a
        GLOBAL.editbasic.jxaddress.jxtwo = obj.b
        GLOBAL.editbasic.jxaddress.jxthree = obj.c
