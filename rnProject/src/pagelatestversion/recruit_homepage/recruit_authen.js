 ...
 * @Last Modified time: 2019-03-29 16:07:15
 * Module:认证服务
 */
...
export default class authen extends Component {
    ...
    clickRz() {
        if (!this.state.isYes) {
            ...
            this.props.navigation.navigate('Recruit_authenpay')
        }
    }
    // 弹窗关闭开关
    alertfun() {
            ...
            <View style={styles.containermain}>
                ...
                <ScrollView style={{ width: '100%', flex: 1, }}>
                    <View style={{ flexDirection: "row", justifyContent: 'center' }}>
                        <Image style={{ width: 360, height: 87, marginLeft: 20, marginRight: 20, marginTop: 8, marginBottom: 100 }}
                    ...
                    <View style={{ flexDirection: "row", justifyContent: 'center' }}>
                        <ImageBackground style={{ width: 378, height: 200, }}
                    ...
                    {/* 购买认证 */}
                    <TouchableOpacity onPress={() => this.clickRz()} style={{ height: 42, marginTop: 10, marginBottom: 4, marginLeft: 10, marginRight: 10, backgroundColor: "#eb4e4e", borderRadius: 4, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', }}>
