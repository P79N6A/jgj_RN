 ...
 * @Last Modified time: 2019-04-08 15:18:58
 * Module:工人/班组-品牌班组
 */
...
class List extends React.Component {
    ...
    render() {
        ...
        return (
            <TouchableOpacity activeOpacity={0.5} onPress={() => this.props.navigate.navigate('Personal_preview', { uid: item.uid, fromTo: 'yzlw', role_type: '2' })}>
                <View style={{
                    flexDirection: 'row',
                    alignItems: 'center',
                                ...
                                <View style={{
                                ...
                                }}>
                                    {
                                        item.experience.pro_name ? (
                                            <Text style={{ color: '#000', height: 15.4, height: 23 }}>
...

                                    {
                                        item.experience.content ? (
                                            <Text style={{ color: '#666', height: 15.4, height: 23, marginTop: 2.2 }}>
