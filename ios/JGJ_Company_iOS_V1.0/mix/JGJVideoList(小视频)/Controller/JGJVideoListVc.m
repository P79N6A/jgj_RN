...
- (void)videoListCell:(JGJVideoListCell *)cell buttonType:(JGJVideoListCellButtonType)buttonType {
    ...
    switch (buttonType) {
        ...
        case JGJVideoListCellButtonComType:{
            ...
            [self handleButtonActionWithCell:cell buttonType:JGJVideoListCellButtonComType];
        }
        ...
        case JGJVideoListCellButtonNameHeadType:{
            ...
            [self handleButtonActionWithCell:cell buttonType:JGJVideoListCellButtonNameHeadType];
        }
            break;
...
- (void)handleButtonActionWithCell:(JGJVideoListCell *)cell buttonType:(JGJVideoListCellButtonType)buttonType {
    ...
    switch (buttonType) {
        ...
        case JGJVideoListCellButtonNameHeadType:{
            ...
            if (self.responseCallback) {
                ...
                self.responseCallback(@{@"uid" : cell.listModel.user_info.uid?:@""});
            }
        }
        ...
        case JGJVideoListCellButtonComType:{
            ...
            if (self.responseCallback) {
                ...
                self.responseCallback(@{@"id" : cell.listModel.post_id?:@""});
            }
        }
...
//pic: GLOBAL.imgUrl + data.pic_src[0]
    ...
    NSString *url =[NSString stringWithFormat:@"%@dynamic/info?id=%@&plat=manage", JGJWebDiscoverURL,listModel.post_id];
