...
#define ContainViewW 200
#define ContainViewH 220
...
//    CGFloat popDetailHeight = [_popView.popDetailLable contentSizeFixWithWidth:ContainViewW].height;
...
- (IBAction)handleUpdateButtonPressed:(UIButton *)sender {
   NSURL *url = [NSURL URLWithString:@"https://itunes.apple.com/app/id1163666807"];
