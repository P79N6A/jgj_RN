...
- (UIImage*)defaultIcon{
    if (!_defaultIcon) {
        ...
        _defaultIcon = [self loadPlistIcon] ?:[UIImage imageNamed:@"AppIcon"] ?:[UIImage imageNamed:@"AppIcon-1"] ?:[UIImage imageNamed:@"AppIcon-2"] ?:[UIImage imageNamed:@"AppIcon-3"] ?:[UIImage imageNamed:@"Logo"]?:[UIImage imageNamed:@"JKNotifier_default_icon"];
    }
    return _defaultIcon;
}
