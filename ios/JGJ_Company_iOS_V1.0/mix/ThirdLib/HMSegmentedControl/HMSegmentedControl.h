...
- (void)showLeftArrow:(HMSegmentedControl *)segmentedControl;

- (void)showRightArrow:(HMSegmentedControl *)segmentedControl;
...
//Tony修改过的地方
@property (nonatomic, assign) CGFloat subTextLayerWith;
...
/**
 ...
 自定义的指示器的宽度
 */
@property (nonatomic, assign) CGFloat customIndicatorWidth;
