...
-(instancetype)initWithUrl:(NSURL *)url{
    ...
    if (self) {
        self.url = url;
        _progressViewColor = JLGBlueColor;
    }
    return self;
}
...
-(UIBarButtonItem*)customBackBarItem{
    if (!_customBackBarItem) {
        UIImage* backItemImage = [[UIImage imageNamed:@"barButtonItem_back"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
