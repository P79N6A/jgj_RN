...
//2.1.0添加修改
//#define KJGJFSCalendar_2_1_0 YES
...
#pragma mark - 后期添加
    collectionView.layer.shouldRasterize = YES;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    for (FSCalendarCell *fscell in collectionView.visibleCells) {
        for (UIView *view in fscell.subviews) {
            if (view.tag == 1122) {
...
//            }
//            if (view.tag == 10 || view.tag == 789||view.tag == 130 ||view.tag == 131) {
//                [view removeFromSuperview];
//            }
//            if (view.tag == 121) {
//                [view removeFromSuperview];
...
//    moreday55
    ...
    if (_scope == FSCalendarScopeMonth) {
        if (_lineLable) {
            [_lineLable removeFromSuperview];
        }
        _lineLable = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, TYGetUIScreenWidth, 0.5)];
        _lineLable.backgroundColor = AppFontdbdbdbColor;
        _lineLable.tag = 202;
...
-(void)startanimationwithcell:(UICollectionViewCell*)cell{
    
    UIView *holdview = [[UIView alloc]initWithFrame:CGRectMake(0, 0, CGRectGetWidth(cell.frame), CGRectGetHeight(cell.frame))];
//    holdview.backgroundColor = AppFontffffffColor;
