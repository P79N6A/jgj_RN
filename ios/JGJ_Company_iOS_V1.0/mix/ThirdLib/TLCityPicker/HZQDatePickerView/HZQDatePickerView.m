...
- (void)awakeFromNib {
    ...
    [self.sureBtn setTitleColor:TYColorHex(0x37ca79) forState:UIControlStateNormal];

    self.sureBtn.layer.borderColor = TYColorHex(0x37c3a9).CGColor;
    self.sureBtn.layer.masksToBounds = YES;
    
    /** 取消按钮 */
    self.cannelBtn.layer.cornerRadius = 4;
    self.cannelBtn.layer.borderWidth = 1;
    self.cannelBtn.layer.borderColor = TYColorHex(0xbab9b9).CGColor;
