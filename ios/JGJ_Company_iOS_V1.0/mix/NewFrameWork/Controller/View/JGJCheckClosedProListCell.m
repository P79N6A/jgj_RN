...
@property (weak, nonatomic) IBOutlet UILabel *groupCreatDes;

@property (weak, nonatomic) IBOutlet NSLayoutConstraint *groupCreatDesW;

@property (weak, nonatomic) IBOutlet NSLayoutConstraint *groupCreatDesTrail;
...
- (void)awakeFromNib {
    ...
    self.proNameLable.preferredMaxLayoutWidth = TYGetUIScreenWidth - 185;
    
    self.proNameLable.numberOfLines = 0;
    
    self.groupCreatDes.textColor = AppFont999999Color;
    
    self.groupCreatDes.font = [UIFont systemFontOfSize:AppFont26Size];
}
...
- (void)setGroupListModel:(JGJChatGroupListModel *)groupListModel {
    ...
    self.groupCreatDesW.constant = 90;
    ...
    if (isMySelfGroup) {
        ...
        self.groupCreatDesW.constant = 0;
        
    }
    
    self.groupCreatDes.text = myGroupFlagStr;
...
- (void)setSubViewConstantWithGroupListModel:(JGJChatGroupListModel *)groupListModel {
    ...
    if (isMySelfGroup && is_readed_msg) { //我创建的、全部已读
        ...
        self.groupCreatDesTrail.constant = 10;
        
    }else if (isMySelfGroup && !is_readed_msg) { //我创建的、有未读消息
        
       self.groupCreatDesW.constant = 90;
        
       self.groupCreatDesTrail.constant = 28;
        ...
        self.groupCreatDesTrail.constant = 0;
    }
