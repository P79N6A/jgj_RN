...
//        [self.contenImage sd_setImageWithURL:[NSURL URLWithString:[JLGHttpRequest_UpLoadPicUrl stringByAppendingString:model.msg_src[0]]]];
...
//    [self.contentLable markMoreText:noticeType?:@"" withColor:AppFont628ae0Color];
