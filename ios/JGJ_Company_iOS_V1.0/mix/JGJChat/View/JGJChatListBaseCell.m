...
#pragma mark - 文字行数适配  原代码   self.contentLabel.numberOfLines = 2;  LYQ
    ...
    self.contentLabelMaxW = TYIS_IPHONE_5_OR_LESS?202:(TYIS_IPHONE_6 || TYIST_IPHONE_X ? 220 : 260);
    
    self.contentLabel.preferredMaxLayoutWidth = TYIS_IPHONE_5_OR_LESS?202:(TYIS_IPHONE_6 || TYIST_IPHONE_X ? 220 : 260);
...
- (void)handleCheckInfo:(UITapGestureRecognizer *)tap {
    ...
    if (_jgjChatListModel.sendType == JGJChatListSendFail) {
