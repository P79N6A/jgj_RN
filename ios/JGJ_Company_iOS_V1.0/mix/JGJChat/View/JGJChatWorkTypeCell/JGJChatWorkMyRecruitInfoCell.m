//
//  JGJChatWorkMyRecruitInfoCell.m
//  mix
//
...
@interface JGJChatWorkMyRecruitInfoCell ()
...
@end
@implementation JGJChatWorkMyRecruitInfoCell
...
- (void)setChatListModel:(JGJChatMsgListModel *)chatListModel {
    ...
    if (_chatListModel.recruitMsgModel.classes.cooperate_type.type_id == 1) { //点工
        ...
        if ([money isEqualToString:@"0"] || [NSString isEmpty:money]) {
            ...
            self.verbTreatmentInfo.text = [NSString stringWithFormat:@"开工时间：%@\n工钱：%@", time?:@"",unitStr];
            
            [self.verbTreatmentInfo markattributedTextArray:@[chatListModel.recruitMsgModel.classes.work_begin?:@"",unitStr] color:AppFontd7252cColor font:FONT(12) isGetAllText:YES withLineSpacing:5];
            ...
            [self.verbTreatmentInfo markattributedTextArray:@[_chatListModel.recruitMsgModel.classes.work_begin?:@"",merMoney] color:AppFontd7252cColor font:FONT(12) isGetAllText:YES withLineSpacing:5];
        }
    ...
    if (_chatListModel.recruitMsgModel.classes.cooperate_type.type_id == 4) { //突击队
        ...
        self.verbTreatmentInfoConstraintH.constant = verbTreatmentInfoH;
