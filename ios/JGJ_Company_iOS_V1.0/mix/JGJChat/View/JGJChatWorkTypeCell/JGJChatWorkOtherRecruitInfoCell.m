...
- (void)setChatListModel:(JGJChatMsgListModel *)chatListModel {
    ...
    if (_chatListModel.recruitMsgModel.classes.cooperate_type.type_id == 1) { //点工
        ...
        if ([money isEqualToString:@"0"] || [NSString isEmpty:money]) {
            ...
            [self.verbTreatmentInfo markattributedTextArray:@[_chatListModel.recruitMsgModel.classes.work_begin?:@"",unitStr] color:AppFontd7252cColor font:FONT(12) isGetAllText:YES withLineSpacing:5];
