...
//当前表情键盘所属的控制器
@property (strong, nonatomic) UIViewController *belongVc;
@end
    ...
    switch (_statusType) {
        ...
        case JGJKeyboardFaceStatusType:{
            ...
            if (!self.belongVc) {
                ...
                self.belongVc = [self getCurrentViewController];
            }
            
            [self.belongVc.view addSubview:self.emotionKeyboard];
...
//    
//    TYLog(@"---------%@", @(scrollView.contentSize.height));
//}
