    ...
    switch (signCellType) {
        ...
        case JGJSignCellRemarkMediaCellType:{
            ...
            if (TYIS_IPHONE_5) {
                ...
                offset = (count == 3 || count == 6) ? 103 : CGFLOAT_MIN;
                
            }else {
                
                offset = (count == 4 || count == 8) ? 103 : CGFLOAT_MIN;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (signCellType) {
        ...
        case JGJSignCellAddressAdjustType:{
            ...
            adjustButtonSignCell.retryButton.hidden = self.signVcType != JGJChatSignVcUseType;
        ...
        case JGJSignCellRemarkTitleType:{
            ...
            remarkTitleCell.lineView.hidden = YES;
