...
- (void)SegmentTapView{
    ...
    self.titles = @[@"未读",@"已读"];
    self.segmentTapView = [[SegmentTapView alloc] initWithFrame:CGRectMake(0, kJGJReadInfoVcSegmentY, TYGetUIScreenWidth, kJGJReadInfoVcSegmentH) withDataArray:self.titles withFont:15.0];
