...
#define ProDetailContentViewH 235

#define ProDetailTopViewH 80

#define ProDetailBottomViewH 100
...
@class JGJChatMsgListModel,ChatMsgList_Read_info,ChatMsgList_Read_User_List;
...
@property (nonatomic, copy) NSString *workingNotify_msg_text;
@property (nonatomic, copy) NSAttributedString *htmlStr;
