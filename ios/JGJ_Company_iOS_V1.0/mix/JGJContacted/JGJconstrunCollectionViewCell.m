...
- (void)awakeFromNib {
    ...
    UILabel *lable = [[UILabel alloc]initWithFrame:CGRectMake(10, 84.5, TYGetUIScreenWidth - 20,0.5)];
...
{
    if (!_placeView) {
        _placeView = [[UIView alloc]initWithFrame:CGRectMake(10, 1.5, TYGetUIScreenWidth - 20, 70)];
...
//        [_placeView addSubview:self.noneLable];
...
{
    if (!_templablem) {
        _templablem = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(_templable.frame) + 1, 0, (int)(76 * (TYGetUIScreenWidth - 20)/ 351) , 34)];
...
{
    if (!_templablea) {
        _templablea = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(_templable.frame) + 1, 35, (int)(76 * (TYGetUIScreenWidth - 20)/ 351) , 35)];
...
{
    if (!_noneLable) {
        _noneLable = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(_templablea.frame)-1.2 , 0, 1.2, 70)];
        _noneLable.backgroundColor = [UIColor whiteColor];
    }
...
{
    if (!_windlablea) {
        _windlablea = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(_windlable.frame) + 1, 35, (int)(75 * (TYGetUIScreenWidth - 20)/ 351), 35)];
...
{
    if (!_windlablem) {
        _windlablem = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(_windlable.frame) + 1, 0, (int)(75 * (TYGetUIScreenWidth - 20)/ 351), 34)];
