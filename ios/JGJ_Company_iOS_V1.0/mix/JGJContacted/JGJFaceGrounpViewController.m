...
@property(nonatomic,strong)YQShadowLable *onelable;
...
-(JGJAddPeopleToGroupListView *)listcollectionview
{
    if (!_listcollectionview) {
        _listcollectionview = [[JGJAddPeopleToGroupListView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(_bottomLable.frame)+5-JGJ_IphoneX_BarHeight, ScreenWidth.width, ScreenWidth.height-CGRectGetMaxY(_bottomLable.frame))];
...
-(YQShadowLable *)OnePassWorldLable
{
    if (!_OnePassWorldLable) {
        
        
        _OnePassWorldLable = [[YQShadowLable alloc]initWithFrame:CGRectMake((ScreenWidth.width-203)/2, CGRectGetMaxY(_DesCriptionLable.frame)+22, 38, 54)];
...
-(YQShadowLable *)onelable
{
    if (!_onelable) {
        _onelable = [[YQShadowLable alloc]initWithFrame:CGRectMake((ScreenWidth.width-203)/2, CGRectGetMaxY(_DesCriptionLable.frame)+22, 38, 54)];
        //        _OnePassWorldLable.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"bg_facetoface@2x"]];
        _OnePassWorldLable.backgroundColor = [UIColor grayColor];
        
        //        _OnePassWorldLable.textColor =  RGB_COLOR(9, 154, 255);
        [self.view addSubview:_OnePassWorldLable];
        _OnePassWorldLable.layer.masksToBounds = YES;
        _OnePassWorldLable.layer.cornerRadius = 4;
        _OnePassWorldLable.textAlignment = NSTextAlignmentCenter;
        _OnePassWorldLable.font = [UIFont systemFontOfSize:23];
...
-(YQShadowLable *)TwoPassWorldLable
{
    if (!_TwoPassWorldLable) {
        _TwoPassWorldLable = [[YQShadowLable alloc]initWithFrame:CGRectMake(CGRectGetMaxX(_OnePassWorldLable.frame)+17, CGRectGetMaxY(_DesCriptionLable.frame)+22, 38, 54)];
...
-(YQShadowLable *)ThreePassWorldLable
{
    
    if (!_ThreePassWorldLable) {
        
        
        _ThreePassWorldLable = [[YQShadowLable alloc]initWithFrame:CGRectMake(CGRectGetMaxX(_TwoPassWorldLable.frame)+17, CGRectGetMaxY(_DesCriptionLable.frame)+22, 38, 54)];
...
-(YQShadowLable *)FourPassWorldLable
{
    
    if (!_FourPassWorldLable) {
        
        
        _FourPassWorldLable = [[YQShadowLable alloc]initWithFrame:CGRectMake(CGRectGetMaxX(_ThreePassWorldLable.frame)+17, CGRectGetMaxY(_DesCriptionLable.frame)+22, 38, 54)];
