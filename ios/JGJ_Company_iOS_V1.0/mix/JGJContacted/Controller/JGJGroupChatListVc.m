...
- (void)viewDidLoad {
    ...
    if (self.groupChatListVcType == JGJGroupChatListWorkVcType) {
        self.title = @"选择项目";
...
//    if (self.groupChatListVcType != JGJGroupChatListWorkVcType) { //项目有搜索
//        return;
//    }
...
- (void)groupChatListVcTableView:(UITableView *)tableView didSelectedGroupListModel:(JGJMyWorkCircleProListModel *)groupListModel {
    ...
    chatRootVc.workProListModel = groupListModel; //进入群聊
