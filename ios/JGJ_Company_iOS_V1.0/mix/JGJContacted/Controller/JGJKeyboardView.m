...
//                [_numbutton setBackgroundImage:[UIImage imageNamed:@"paizhao"] forState:UIControlStateSelected];
            ...
            _tagNum =_tagNum+j*3;
                ...
                _numbutton.titleLabel.font = [UIFont systemFontOfSize:20];
              ...
              //  [_numbutton setImage:[JGJGetViewFrame saImageWithSingleColor:[UIColor whiteColor]] forState:UIControlStateHighlighted];
...
//    sender.showsTouchWhenHighlighted = YES;
    NSLog(@"----------------------------");
    if (self.numdelegate&&[self.numdelegate respondsToSelector:@selector(ClickKeyBoardnumberButtonToString:)]) {
        [self.numdelegate ClickKeyBoardnumberButtonToString:[NSString stringWithFormat:@"%ld",(long)sender.tag]];
    }
