...
- (void)awakeFromNib {
    ...
    [self.detailTV setPlaceholderStr:@"此处请填写备注，也可以用下面照片或语音记录" placeholderColor:AppFontccccccColor];
...
//    NSInteger layoutW = _audioViewLayoutWidth*audioLayoutTime/60.0;//60s
    ...
    self.playAudioButtonLayoutW.constant = layoutW;
...
//-(TYTextView *)detailTV
//{
//    [_detailTV setFrame:CGRectMake(0, 10, 300, 100)];
//
//
//    return _detailTV;
//}
...
//            
//            cellHeight =    allMargin  + [self RowHeight:self.detailTV.text];
//  
//        }
