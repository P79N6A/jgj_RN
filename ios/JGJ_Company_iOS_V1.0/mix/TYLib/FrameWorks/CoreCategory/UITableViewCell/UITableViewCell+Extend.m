...
+ (UITableViewCell *)setNilViewCell:(UITableView *)tableView indexPath:(NSIndexPath *)indexPath{
...
+(instancetype)cellWithTableView:(UITableView *)tableView forIndexPath:(NSIndexPath *)indexPath{
    ...
    //从缓存池中取出cell
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:MyIdentifierID forIndexPath:indexPath];
