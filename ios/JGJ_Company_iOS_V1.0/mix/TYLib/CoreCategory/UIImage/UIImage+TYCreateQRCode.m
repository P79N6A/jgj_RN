...
@implementation UIImage (TYCreateQRCode)
 ...
 * 回调函数
 */
void TYCreateQRProviderReleaseData(void * info, const void * data, size_t size) {
    free((void *)data);
}
...
+ (UIImage *)imageFillBlackColorAndTransparent: (UIImage *)image red: (NSUInteger)red green: (NSUInteger)green blue: (NSUInteger)blue
{
    ...
    CGDataProviderRef dataProvider = CGDataProviderCreateWithData(NULL, rgbImageBuf, bytesPerRow, TYCreateQRProviderReleaseData);
