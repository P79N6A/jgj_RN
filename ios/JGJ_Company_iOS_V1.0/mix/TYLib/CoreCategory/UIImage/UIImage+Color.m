...
//给我一种颜色，一个尺寸，一个字符串，我给你返回一个UIImage
+(UIImage *)imageFromContextWithColor:(UIColor *)color size:(CGSize)size str:(NSString *)str{
    ...
    // 设置文字背景颜色
    md[NSBackgroundColorAttributeName] = color;
    // 设置文字大小
    md[NSFontAttributeName] = [UIFont systemFontOfSize:16.0];
