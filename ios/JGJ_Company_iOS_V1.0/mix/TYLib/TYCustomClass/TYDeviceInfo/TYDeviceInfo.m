...
+ (NSDictionary *)getBaseInfo{
    ...
    baseInfo[@"iPhoneName"] = iPhoneName;
    
    baseInfo[@"appVerion"] = appVerion;
    
    baseInfo[@"batteryLevel"] = @(batteryLevel);
    
    baseInfo[@"localizedModel"] = localizedModel;
    
    baseInfo[@"systemName"] = systemName;
    
    baseInfo[@"systemVersion"] = systemVersion;
