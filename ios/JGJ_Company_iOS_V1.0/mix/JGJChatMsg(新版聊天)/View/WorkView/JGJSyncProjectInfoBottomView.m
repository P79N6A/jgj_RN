...
- (void)setMsgModel:(JGJChatMsgListModel *)msgModel {
    ...
    if (_msgModel.chatListType == JGJChatListDemandSyncProjectType) {
        ...
        if ([JGJChatMsgDBManger queryLocalIsHaveTeamProject]) {
            ...
            [_leftBtn setTitle:@"创建新项目组" forState:(UIControlStateNormal)];
            
            [_rightBtn setTitle:@"加入现有项目组" forState:(UIControlStateNormal)];
            _rightBtn.backgroundColor = [UIColor whiteColor];
            [_rightBtn setTitleColor:AppFont000000Color forState:(UIControlStateNormal)];
            ...
            [_leftBtn mas_updateConstraints:^(MASConstraintMaker *make) {
                ...
                make.left.mas_equalTo(TYGetUIScreenWidth / 2 - btnWidth / 2);
            }];
        }
