...
//    //
//    [MobClick startWithAppkey:@"57eccabde0f55a2fc2003b01" reportPolicy:(ReportPolicy) BATCH channelId:nil];
...
#pragma mark - JSPatch
//+ (void)checkPatch{
//    if (JSPatchLocalTest) {//JSPatch本地测试
//        [JPEngine startEngine];
//        NSString *sourcePath = [[NSBundle mainBundle] pathForResource:@"mainTest" ofType:@"js"];
...
//        
//        //设置Key
//        [JSPatch setupRSAPublicKey:@"-----BEGIN PUBLIC KEY-----MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCv5hu1ey6dzXpJbvKbb5dQC+dnYVTOJTNj1Ld8dh2Pt0jiE87MVFY9SqBy6MQuzyEiR3g2MYKHu09lDsCBRLvTvGe9lgj39nl47na65wfFxfkQO2Q0pQj7h6wSjTrdD93AZMWVWDCn6AZdmTZggMFe+vdDvLWUEZd12dXzf9EuswIDAQAB-----END PUBLIC KEY-----"];
//        
//        [JSPatch sync];
//        
//        
