...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.WorkCicleProListModel.logTypes == choicelogTemplateType) {
        ...
        if (indexPath.row == 0) {
            ...
            CalendarproCell.proName = _WorkCicleProListModel.all_pro_name ? : @"";
...
//            if (_eidteBuilderDaily) {
//
//                _recipientCell.hidden = YES;
//            }else {
//
//                _recipientCell.hidden = NO;
//            }
...
//            }
        ...
        if (indexPath.row == 0) {
            ...
            //        if (_WorkCicleProListModel.logTypes == choicelogTemplateType) {
            JLGAddProExperienceTableViewCell *returnCell = [JLGAddProExperienceTableViewCell cellWithTableView:tableView];
...
//            }else {
//
//                NSLog(@"接收人高度 = %f",[JGJTeamMemberCell calculateCollectiveViewHeight:self.membersArr headerHeight:CheckPlanHeaderHegiht]);
...
//    if (_eidteBuilderDaily) {
//
//        [_MoreparmDic setObject:_receiver_uid?:@"-1" forKey:@"rec_uid"];
//
//    }else {
...
//    }
    ...
    if (_eidteBuilderDaily) {
        //    [self.MoreparmDic setObject:_chatMsgListModel.cat_id?:@"" forKey:@"cat_id"];
        if (_chatRoomGo) {
...
//            if ([NSString isEmpty:recordRainModel.weat_two] && ![NSString isEmpty: recordRainModel.weat_one]) {
//
//                _sendDailyModel.weat_am = recordRainModel.weat_one;
//                _sendDailyModel.weat_pm = recordRainModel.weat_one;
//
//            }else if([NSString isEmpty: recordRainModel.weat_three] && ![NSString isEmpty: recordRainModel.weat_two]){
//
//                _sendDailyModel.weat_am = recordRainModel.weat_one;
//                _sendDailyModel.weat_pm = recordRainModel.weat_two;
//
//            }else if ([NSString isEmpty: recordRainModel.weat_four] && ![NSString isEmpty: recordRainModel.weat_three])
//            {
...
//                _sendDailyModel.weat_pm = recordRainModel.weat_three;
//
//            }else if (![NSString isEmpty: recordRainModel.weat_four]){
//
//                _sendDailyModel.weat_am = [[recordRainModel.weat_one?:@"" stringByAppendingString:@">"] stringByAppendingString:recordRainModel.weat_two?:@""];
...
-(UITableViewCell *)accordingLogTempretrueType:(NSString *)type indexpathRow:(NSIndexPath *)indexPath
{
    ...
    }else if ([type isEqualToString:@"text"])
    {
        ...
        if (indexPath.row ==1 && indexPath.section == 0) {
            ...
            singgerInputCell.constance.constant = 2;
            singgerInputCell.contantcenterConstance.constant = 0.5;
        }else{
            
            singgerInputCell.departConstance.constant = 10;
            singgerInputCell.constance.constant = 7;
            singgerInputCell.contantcenterConstance.constant = 5;
        }
    ...
    }else if ([type isEqualToString:@"number"])
    {
        ...
        if (indexPath.row ==1 && indexPath.section == 0) {
            ...
            singgerNumInputCell.centerconstance.constant = 2;
            singgerNumInputCell.contentCenterConstance.constant = 0.5;
            singgerNumInputCell.imageCenterConstance.constant = 0.5;
            
        }else{
            singgerNumInputCell.departConstance.constant = 10;
            singgerNumInputCell.centerconstance.constant = 7;
            singgerNumInputCell.contentCenterConstance.constant = 5;
            singgerNumInputCell.imageCenterConstance.constant = 5;
        }
...
//                [weakSelf.MoreparmDic setObject:[NSString getJsonByData:locationDic] forKey:strongSelf -> _locationJsonKey];
