...
- (void)setNotifyModel:(JGJNewNotifyModel *)notifyModel {
    ...
    switch (notifyModel.notifyType) {
        ...
        case SyncNoticeTargetType: //同步记工通知
...
- (IBAction)buttonPressed:(UIButton *)sender {
    ...
    //记工同步通知类型
    if (self.notifyModel.notifyType == SyncNoticeTargetType && type != NotifyCellDeleteButtonType) {
        
        type = NotifyCellSyncNoticeTargetType;
