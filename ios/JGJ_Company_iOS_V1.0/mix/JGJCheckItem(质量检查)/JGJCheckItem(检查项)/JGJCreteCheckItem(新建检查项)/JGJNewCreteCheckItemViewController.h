//
//  JGJNewCreteCheckItemViewController.h
//  JGJCompany
//
...
@interface JGJNewCreteCheckItemViewController : UIViewController
...
@property (assign, nonatomic) BOOL createCheckItemGo;//新建检查项返回默认选中

@property (assign, nonatomic) BOOL checkItemNodata;//质量检查首页进入当没有检查项的时候进入到新建检查项  创建成功后直接回到见哈想列表
@property (strong, nonatomic) IBOutlet UIView *bottomViews;
