...
#define LGSCREEN_HEIGHT [[UIScreen mainScreen] bounds].size.height - [[UIApplication sharedApplication] statusBarFrame].size.height
#define LGSCREEN_WIDTH [[UIScreen mainScreen] bounds].size.width
