...
//    longPresssRecognizer.numberOfTouchesRequired = 1;
...
//        if ([assetCollection.localizedTitle isEqualToString:@"吉工家"]) {
//            //说明已经有哪对象了
...
//        // 创建相簿的请求
//        assetCollectionLocalIdentifier = [PHAssetCollectionChangeRequest creationRequestForAssetCollectionWithTitle:@"吉工家"].placeholderForCreatedAssetCollection.localIdentifier;
//    } error:&error];
//
//    if (error)return nil;
//
