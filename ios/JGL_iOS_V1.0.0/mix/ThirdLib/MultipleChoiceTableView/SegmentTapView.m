...
#define lineImageViewH 2.5

@interface SegmentTapView ()
@property (nonatomic, strong)NSMutableArray *buttonsArray;
@property (nonatomic, strong)UIImageView *lineImageView;
//是否使用粗体,YES:正常字体，非粗体，NO:粗体
@property (nonatomic, assign) BOOL isNormalFont;
...
-(instancetype)initWithFrame:(CGRect)frame withDataArray:(NSArray *)dataArray withFont:(CGFloat)font isNormalFont:(BOOL )isNormalFont{
    self.isNormalFont = isNormalFont;
    self = [self initWithFrame:frame withDataArray:dataArray withFont:font];
