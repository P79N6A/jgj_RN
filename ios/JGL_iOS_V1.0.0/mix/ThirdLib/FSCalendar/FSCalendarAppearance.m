...
- (void)setTodayColor:(UIColor *)todayColor
{
    ...
    self.afterTodayTitleColor = todayColor;
    self.afterTodaySubTitleColor = todayColor;
...
//    return [UIFont fontWithName:_titleFontName size:_adjustsFontSizeToFitContentSize?_preferredTitleFontSize:_titleFontSize];
    return [UIFont boldSystemFontOfSize:_adjustsFontSizeToFitContentSize?_preferredTitleFontSize:_titleFontSize];
}
...
{
    //Tony修改过的地方
    CGFloat fontSize = 0.85*(_adjustsFontSizeToFitContentSize?_preferredWeekdayFontSize:_weekdayFontSize);
    return [UIFont fontWithName:_weekdayFontName size:fontSize];
}
