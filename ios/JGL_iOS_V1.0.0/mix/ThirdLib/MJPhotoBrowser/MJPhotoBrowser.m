...
- (void)addLongPressGesture {
    ...
    UILongPressGestureRecognizer *longPresssRecognizer = [[UILongPressGestureRecognizer alloc] initWithTarget:self action:@selector(longTapSaveImageWithPress:)];
    
    longPresssRecognizer.minimumPressDuration = 0.4;
    
    [self.view addGestureRecognizer:longPresssRecognizer];
    

}

- (void)longTapSaveImageWithPress:(UILongPressGestureRecognizer *)press {
