...
@interface IDJCalendar : NSObject{
    ...
    NSString *month;//月份
    NSString *day;//日期
    NSString *des_year;//转换后年份
    NSString *des_month;//转换后月份
    NSString *des_day;//转换后日期
    NSString *weekday;//星期
...
@property (nonatomic, copy) NSString * des_year;
@property (nonatomic, copy) NSString * des_month;
@property (nonatomic, copy) NSString * des_day;
