...
- (id)initWithYearStart:(NSUInteger)start end:(NSUInteger)end IDJCalendar:(IDJCalendar *)calendar{
    self=[super initWithYearStart:start end:end IDJCalendar:calendar];
    if (self) {
...
- (NSMutableArray *)daysInMonth:(NSString *)_month year:(NSUInteger)_year {
    ...
    NSUInteger month_=[IDJCalendarUtil monthFromMineToCppWithYear:_year month:_month];
    int dayCounts=ChineseCalendarDB::GetMonthDays((int)_year, (int)month_);
