...
-(UIImageView *)titleImageView
{
    if (!_titleImageView) {
        ...
        _titleImageView.image = [UIImage imageNamed:@"help_title_center_icon"];
    }
...
- (void)setPushHelpWebVcWithTitleViewType:(JGJHelpCenterTitleViewType)titleViewType targetVc:(UIViewController *)targetVc {
    ...
    switch (self.titleViewType) {
        ...
        case JGJHelpCenterTitleViewQualityType:{
            ...
            if ([self.proListModel.class_type isEqualToString:@"group"]) {
        ...
        case JGJHelpCenterTitleViewRecordBillingType:{
        ...
        case JGJHelpCenterTitleViewUnWageType:{
            
             helpid = @"216";
        }
            break;
            
        case JGJHelpCenterSetAgencyType:{
