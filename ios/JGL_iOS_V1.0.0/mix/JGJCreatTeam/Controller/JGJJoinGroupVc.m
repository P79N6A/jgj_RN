...
- (IBAction)joinBtnClick:(id)sender {
    ...
    [JLGHttpRequest_AFN PostWithNapi:JGJAddMembersURL parameters:parameters success:^(id responseObject) {
        ...
        if ([self.addGroupMemberRequestModel.class_type isEqualToString:@"singleChat"] || [self.addGroupMemberRequestModel.class_type isEqualToString:@"groupChat"]) {
            
            [TYLoadingHub hideLoadingView];
            
            [self handleChatAction:self.proListModel];
            
        }else if ([self.addGroupMemberRequestModel.class_type isEqualToString:@"team"] || [self.addGroupMemberRequestModel.class_type isEqualToString:@"group"]) {
...
//    }
    ...
    [JLGHttpRequest_AFN PostWithNapi:@"chat/set-index-list" parameters:body success:^(id responseObject) {
        ...
        [JGJChatGetOffLineMsgInfo shareManager].getIndexListSuccess = ^(JGJMyWorkCircleProListModel *proListModel) {
            ...
            [weakself joinMyChatGroupsVc:proListModel];
...
- (void)joinMyChatGroupsVc:(JGJMyWorkCircleProListModel *)worlCircleModel {
