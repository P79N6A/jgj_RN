...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *bottomTrail;

@property (weak, nonatomic) IBOutlet NSLayoutConstraint *bottomLead;

@property (weak, nonatomic) IBOutlet NSLayoutConstraint *topTrail;

@property (weak, nonatomic) IBOutlet NSLayoutConstraint *topLead;
...
//隐藏箭头字灰色
        ...
        self.rightImageView.hidden = _creatTeamModel.isHiddenArrow;
...
- (void)setIsScrBottomLineShow:(BOOL)isScrBottomLineShow {
    
    _isScrBottomLineShow = isScrBottomLineShow;
    
    self.lineView.hidden = NO;
    
    CGFloat padding = isScrBottomLineShow ? 0 : 12;
