...
#import "JGJRecordRainDetailTableViewCell.h"
...
>
{
    JGJRecordRainDetailTableViewCell *recordCell;
...
//            dateCell.editeButton.hidden = NO;
        ...
        recordCell = [[[NSBundle mainBundle]loadNibNamed:@"JGJRecordRainDetailTableViewCell" owner:nil options:nil]firstObject];
...
-(UILabel *)pronamelable
{
    if (!_pronamelable) {
        ...
        _pronamelable = [[UILabel alloc] init];
