...
-(void)showWeatherPickerView
{
    ...
    [UIView animateWithDuration:.15 animations:^{
        ...
        _topView.transform = CGAffineTransformMakeTranslation(0, -265);
        _collectionview.transform = CGAffineTransformMakeTranslation(0, -265);
...
-(UIView *)topView
{
    if (!_topView) {
        ...
        _topView = [[UIView alloc]initWithFrame:CGRectMake(0, 265, TYGetUIScreenWidth, 45)];
...
{
    [_cancelButton setTitle:leftTitle forState:UIControlStateNormal];
    [_surebutton setTitle:rightTitle forState:UIControlStateNormal];
}
...
-(UICollectionView *)collectionview
{
    if (!_collectionview) {
        ...
        _collectionview = [[UICollectionView alloc]initWithFrame:CGRectMake(0,310,[UIScreen mainScreen].bounds.size.width, 220) collectionViewLayout:layout];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0) {
        ...
        if (_classmodel == JGJPacknumPickermodel) {
            ...
            if ([_titlearray[indexPath.row] isEqualToString:_selectedUnits]) {
                
                cell.layer.masksToBounds = YES;
                cell.layer.cornerRadius = 5;
                cell.layer.borderColor = AppFontEB4E4EColor.CGColor;
                cell.layer.borderWidth = 1;
                cell.backgroundColor = AppFontffffffColor;
                cell.detaillable.textColor = AppFontEB4E4EColor;
                ...
                cell.backgroundColor = AppFontEBEBEBColor;
                cell.detaillable.textColor = AppFont333333Color;
            }
...
-(CGSize)collectionView:(UICollectionView *)collectionView layout:(nonnull UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(nonnull NSIndexPath *)indexPath
{
    ...
    if (_classmodel == JGJPacknumPickermodel) {
        return CGSizeMake((TYGetUIScreenWidth - 75) / 4, 40);
    }
         ...
         insetForSectionAtIndex:(NSInteger)section
{
    ...
    if (_classmodel == JGJPacknumPickermodel) {
        ...
        return UIEdgeInsetsMake(15.0f,15, 15.0f, 15);
