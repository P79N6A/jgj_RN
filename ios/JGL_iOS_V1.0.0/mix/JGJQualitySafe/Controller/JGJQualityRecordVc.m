...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    switch (section) {
        ...
        case 4:{
            ...
            JGJTabPaddingView *paddingView = [[JGJTabPaddingView alloc] initWithFrame:CGRectMake(0, 0, TYGetUIScreenWidth, 10)];
            
            paddingView.backgroundColor = AppFontf1f1f1Color;
            
            paddingView.topLineView.hidden = section == 2;
...
- (UITableViewCell *)registerPushImageTableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    returnCell.topLineView.hidden = NO;
    
    returnCell.bottomLineView.hidden = NO;
...
- (JGJCreatTeamCell *)registerLocalLevelCellTableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.lineView.hidden = indexPath.row == 1;
...
- (JGJCreatTeamCell *)registerPrinTimeInfoCellTableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.isScrBottomLineShow = indexPath.row == 3;
