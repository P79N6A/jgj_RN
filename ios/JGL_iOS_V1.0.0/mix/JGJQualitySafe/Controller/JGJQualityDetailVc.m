...
- (void)loadReplyList {
    ...
    NSString *msg_id = self.qualityDetailModel.msg_id;
    
    NSString *msg_type = self.qualityDetailModel.msg_type;
            ...
            case 10:{
                ...
                ATDatePicker *datePicker = [[ATDatePicker alloc] initWithDatePickerMode:UIDatePickerModeDate DateFormatter:@"yyyy-MM-dd" datePickerFinishBlock:^(NSString *dateString) {
                    ...
                    weakSelf.handleModifyInfoBlock = ^(id response) {
                        ...
                        weakSelf.modifyRequstModel.finish_time = nil;
...
- (void)loadNetData {
    ...
    NSString *msg_id = self.listModel.msg_id;
    
    NSString *msg_type = self.listModel.msg_type;
    
    NSString *bill_id = self.listModel.bill_id;
...
- (void)setIndexProListModel:(JGJMyWorkCircleProListModel *)proListModel {
    ...
    [tool switchMyGroupsWithGroup_id:self.qualityDetailModel.group_id?:@"" class_type:self.qualityDetailModel.class_type?:@"" targetVc:self];
