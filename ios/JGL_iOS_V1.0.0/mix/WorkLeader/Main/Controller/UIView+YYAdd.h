...
#ifndef kTYiOS7Later
#define kTYiOS7Later (kSystemVersion >= 7)
#endif

#ifndef kTYiOS8Later
#define kTYiOS8Later (kSystemVersion >= 8)
#endif
...
/*
 ...
 Example: UITYColorHex(0xF0F), UITYColorHex(66ccff), UITYColorHex(#66CCFF88)
 
 Valid format: #RGB #RGBA #RRGGBB #RRGGBBAA 0xRGB ...
 The `#` or "0x" sign is not required.
 */
#ifndef UITYColorHex
#define UITYColorHex(_hex_)   [UIColor colorWithHexString:((__bridge NSString *)CFSTR(#_hex_))]
#endif
