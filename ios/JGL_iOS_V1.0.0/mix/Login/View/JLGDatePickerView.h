...
//@property (nonatomic ,strong)UIButton *recordMoredayButton;
@property (nonatomic ,strong)UIView  *bottemView;;
@property (nonatomic ,strong)NSString  *showMoreButton;

@property (nonatomic, assign) BOOL isShowMoreDayButton;
