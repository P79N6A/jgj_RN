...
typedef NS_ENUM(NSUInteger, EnterPickerViewType) {
    EnterPickerViewTypeDefualt = 0,
    EnterPickerViewTypeLeftMenu
};
...
//进入的类型
@property (assign, nonatomic) EnterPickerViewType enterType;
