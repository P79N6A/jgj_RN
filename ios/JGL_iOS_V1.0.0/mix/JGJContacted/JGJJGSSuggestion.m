...
-(UIButton *)QuitButton
{
    ...
    if (!_QuitButton) {
        _QuitButton = [[UIButton alloc]initWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width-50, 2, 40, 40)];
        [_QuitButton setImage:[UIImage imageNamed:@"icon_closed_normal@2x"] forState:UIControlStateNormal];
