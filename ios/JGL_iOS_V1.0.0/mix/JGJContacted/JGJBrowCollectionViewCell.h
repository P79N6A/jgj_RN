...
@protocol didSelectedbrowTableviewdelegate <NSObject>
...
@end
@interface JGJBrowCollectionViewCell : UICollectionViewCell
@property (nonatomic ,strong)UITableView *BrowTableview;//借支界面
...
@property (weak, nonatomic)id <didSelectedbrowTableviewdelegate> delegate;
