...
#define Padding 12
#define LinViewH 7
@interface JGJUpgradeGroupSelectedMangerVc ()<UITableViewDataSource, UITableViewDelegate>
...
- (IBAction)handleRightItemAction:(UIBarButtonItem *)sender {
    NSDictionary *parameters = @{
                                 ...
                                 @"pro_name" : self.workProListModel.pro_name?:@"",
...
//    workCircleProListModel.class_type = @"group";
//
...
//
//    workCircleProListModel.members_num = [NSString stringWithFormat:@"%@", @(self.members.count)];
//
