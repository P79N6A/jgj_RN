...
+ (JGJShareProDesView *)shareProDesViewWithProDesModel:(JGJShareProDesModel *)proDesModel {
    if(_proDesView && _proDesView.superview) [_proDesView removeFromSuperview];
    ...
    [_proDesView.popDetailLable setAttributedText:proDesModel.popDetail lineSapcing:3.0 textAlign:NSTextAlignmentLeft];
