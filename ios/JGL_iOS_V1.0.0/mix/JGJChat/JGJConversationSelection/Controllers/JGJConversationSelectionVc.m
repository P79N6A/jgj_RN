...
{
    if (!_cancelItem) {
        _cancelItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"close_addNewNotepad"] style:(UIBarButtonItemStyleDone) target:self action:@selector(leftButtonItemClick)];
    }
    return _cancelItem;
}
