...
//PageControl微调顶部间距
#define PageControlOffset 37

#define PageControlH 25

//初始y值微调顶部间距
#define HWEmotionPageViewY 10
...
//        [pageControl setValue:[UIImage imageNamed:@"compose_keyboard_dot_selected"] forKeyPath:@"currentPageImage"];
        ...
        pageControl.pageIndicatorTintColor = AppFontccccccColor;
        
        pageControl.currentPageIndicatorTintColor = AppFont999999Color;
...
- (void)layoutSubviews
{
    ...
    self.pageControl.height = PageControlH;
    self.pageControl.x = 0;
    self.pageControl.y = self.height - self.pageControl.height - PageControlOffset;
