...
- (void)awakeFromNib {
    ...
    self.showHeadPicBtn.userInteractionEnabled = NO;
...
- (void)setAddressBookModel:(JGJSynBillingModel *)addressBookModel {
    ...
    [self.name markText:self.searchValue withColor:AppFontd7252cColor];
    
    [self.telphone markText:self.searchValue withColor:AppFontd7252cColor];
