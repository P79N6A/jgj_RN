...
{//图片选择
    self.superViewController = [viewController mutableCopy];
    
    UIActionSheet *sheet = [[UIActionSheet alloc] initWithTitle:@"头像设置" delegate:self.superViewController cancelButtonTitle:@"取消" destructiveButtonTitle:@"拍照" otherButtonTitles:@"相册", nil];
