...
@property (weak, nonatomic) IBOutlet UIView *topContainTipView;

@property (strong, nonatomic) JGJCustomSearchBar *searchbar;
...
- (void)backButtonPressed:(UIButton *)button {
    ...
    if (self.knowRepoVcBackBlock) {
        
        self.knowRepoVcBackBlock();
    }
...
//        NSMutableArray *topTitleModels = [NSMutableArray new];
//        
//        JGJKnowBaseModel *colBaseModel = [[JGJKnowBaseModel alloc] init];
//        
//        colBaseModel.knowBaseCellType = KnowBaseCollecCellType;
//        
//        colBaseModel.file_name = @"资料收藏夹";
//        
//        [topTitleModels addObject:colBaseModel];
        
        self.topTitleModels = [JGJKnowBaseModel mj_objectArrayWithKeyValuesArray:responseObject];
        
//        [topTitleModels addObjectsFromArray:knowBases];
//        
//        self.topTitleModels = topTitleModels;
