...
@implementation JGJAddNameHUBView

+ (JGJAddNameHUBView *)hasRealNameByVc:(UIViewController <JGJAddNameHUBViewDelegate>*)Vc{
    JGJAddNameHUBView *jgjAddNameHUBView;
    
    if (!JLGIsRealNameBool) {
        jgjAddNameHUBView = [[JGJAddNameHUBView alloc] initWithFrame:TYGetUIScreenRect];
...
- (IBAction)saveBtnClick:(id)sender {
    if ([NSString isEmpty:self.nameTF.text]) {
        [TYShowMessage showError:self.nameTF.placeholder];
        return;
    }
