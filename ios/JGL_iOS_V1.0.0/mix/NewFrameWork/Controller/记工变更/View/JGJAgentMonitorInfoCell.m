...
#define leftContatin 74
#define topContatin 53
#define rightContatin -11
#define bottomContatin -20

@interface JGJAgentMonitorInfoCell ()


@property (nonatomic, strong) JGJWorkpointsChangeListCellTypeView *changeInfoView;// 更改信息

@end
@implementation JGJAgentMonitorInfoCell
...
- (void)initializeAppearance {
    ...
    [self.contentView addSubview:self.otherBubbleView];
...
- (void)setUpLayout {
    ...
    [_otherBubbleView mas_makeConstraints:^(MASConstraintMaker *make) {
...
- (void)setChangeInfoModel:(JGJRecordWorkpointsChangeModel *)changeInfoModel {
    ...
    _otherBubbleView.changeInfoModel = _changeInfoModel;
    _otherBubbleView.indexPath = _indexPath;
...
- (JGJRecordChangeListOtherBubbleView *)otherBubbleView {
    
    if (!_otherBubbleView) {
        
        _otherBubbleView = [[JGJRecordChangeListOtherBubbleView alloc] init];
    }
    return _otherBubbleView;
}
