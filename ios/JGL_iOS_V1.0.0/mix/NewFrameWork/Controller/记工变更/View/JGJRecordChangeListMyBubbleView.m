//
//  JGJRecordChangeListMyBubbleView.m
//  mix
//
...
@interface JGJRecordChangeListMyBubbleView ()
...
@end
@implementation JGJRecordChangeListMyBubbleView
...
- (void)setUpLayout {
    ...
    [_userName mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.equalTo(_userImageView.mas_left).offset(-10);
