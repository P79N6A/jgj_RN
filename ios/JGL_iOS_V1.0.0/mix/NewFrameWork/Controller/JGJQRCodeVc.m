...
//    else if (![NSString isEmpty:strResult.strScanned] && [strResult.strScanned containsString:@"http"] && [self isProStyleWithScanStrResult:strResult.strScanned]) {
//        
//        if ([TYPredicate isCheckUrl:strResult.strScanned]) {
//            
//            BOOL isContainDomainURL = [strResult.strScanned containsString:JGJWebDomainURL];
//            
