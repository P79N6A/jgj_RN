...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == self.mineInfoFirstModel.mineInfos.count - 1) {
        ...
        mineInfoThirdModel.isShowRemark = YES;
        mineInfoThirdModel.remark = @"添加项目经验可快速找到项目";
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch (indexPath.section) {
        ...
        case 2:{
//           detailVc = [[UIStoryboard storyboardWithName:@"MateMine" bundle:nil] instantiateViewControllerWithIdentifier:@"proExperience"];
//            
            detailVc = [[JGJWebAllSubViewController alloc] initWithWebType:JGJWebTypeMyProExp];
        }
            break;
        case 3:{
