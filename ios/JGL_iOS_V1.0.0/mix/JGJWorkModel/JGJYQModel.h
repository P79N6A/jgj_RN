...
@class JGJPoorBillTplModel;
@class JGJPoorBillListDetailModel;
@class JGJRecordWorkpointsDayModel;
...
@property (nonatomic, copy) NSString *element_type;///模板类型
@property (nonatomic, copy) NSString *is_require;//是否必传
@property (nonatomic, copy) NSString *element_key;//模板关键字
@property (nonatomic, copy) NSString *cat_id;//日志类别id
@property (nonatomic, copy) NSString *date_type;//日期类型
...
@property (nonatomic, copy) NSString *length_range;//限制长度
...
@property (nonatomic, assign) BOOL singerTpl;//记账时的弹框
@property (nonatomic, copy) NSString *buttonTitle;//button的按钮名字
@property (nonatomic, copy) NSString *redstr;//标红字体
@property (nonatomic, assign) BOOL blackText;//标红字体
...
@end
//确认差账
@interface JGJSurePoorBillModel : CommonModel

@property (nonatomic, copy) NSString *date_desc;// 用于显示今天/昨天 或者无
@property (nonatomic, copy) NSString *date;
@property (nonatomic, copy) NSString *format_create_time;// 对账界面用这个时间来分组
@property (nonatomic, strong) NSMutableArray <JGJPoorBillListDetailModel *> *list;
@end
@interface JGJPoorBillListDetailModel : CommonModel
@property (nonatomic, copy) NSString *id;
@property (nonatomic, copy) NSString *accounts_type;//记账类型
@property (nonatomic, copy) NSString *working_hours;//上班工时
@property (nonatomic, copy) NSString *manhour;//上班时间
@property (nonatomic, copy) NSString *overtime_hours;//加班工时
@property (nonatomic, copy) NSString *overtime;//加班时间
@property (nonatomic, copy) NSString *salary;//金额
...
@property (nonatomic, strong) JGJPoorBillTplModel *set_tpl;//薪资模板
...
// 3.4.1 cc添加  用于对账界面新增标题 判断类型
@property (nonatomic, copy) NSString *record_type;//1新增 2修改；3删除
@property (nonatomic, copy) NSString *record_desc;//描述

@property (nonatomic, assign) NSInteger contractor_type;// 包工记账 承包 - 分包

@property (nonatomic, assign) CGFloat set_my_amounts_tpl;// 自己对对方设置的工资金额

@property (nonatomic, assign) BOOL is_diff_pro;// 是否有项目差异
@property (nonatomic, copy) NSString *oth_proname;//其他项目名称

@end
@interface JGJPoorBillTplModel : CommonModel
@property (nonatomic, assign) CGFloat s_tpl;
@property (nonatomic, assign) CGFloat w_h_tpl;
@property (nonatomic, assign) CGFloat o_h_tpl;
@property (nonatomic, assign) NSInteger hour_type;
@property (nonatomic, assign) CGFloat o_s_tpl;


@end
@interface JGJDayCheckingModel : CommonModel
@property (nonatomic, copy) NSString *id;
@property (nonatomic, copy) NSString *foreman_name;//工头名称
@property (nonatomic, copy) NSString *worker_name; //工人名称
@property (nonatomic, copy) NSString *accounts_type;//记账类别
@property (nonatomic, copy) NSString *amounts_diff;//差账
@property (nonatomic, copy) NSString *manhour;//上班时间
@property (nonatomic, copy) NSString *overtime;//加班时间
@property (nonatomic, copy) NSString *amounts;//金额
@property (nonatomic, copy) NSString *working_hours;//正常上班工时
@property (nonatomic, copy) NSString *overtime_hours;//加班工时
@property (nonatomic, copy) NSString *pid;//项目id
@property (nonatomic, copy) NSString *proname;//项目名称
@property (nonatomic, assign) NSInteger show_line;// 是否显示-.-
@property (nonatomic, assign) NSInteger is_rest;//是否显示休息
@property (nonatomic, assign) BOOL is_notes;// 是否有备注
@property (nonatomic, assign) NSInteger contractor_type;// 包工记账 承包 - 分包
@end
//记工流水
@interface JGJRecordWorkpointsModel : CommonModel
@property (nonatomic, copy) NSString *total;//
@property (nonatomic, copy) NSString *total_balance;//
@property (nonatomic, copy) NSString *total_income;//
@property (nonatomic, copy) NSString *total_expend;//
@property (nonatomic, strong) NSMutableArray *selectedArray;//

@property (nonatomic, strong) NSArray <JGJRecordWorkpointsDayModel *>*workday;//外面所有的数据
@end

@interface JGJRecordWorkpointsDayModel : CommonModel
@property (nonatomic, copy) NSString *date;//
@property (nonatomic, copy) NSString *date_turn;//
@property (nonatomic, copy) NSArray <MateWorkitemsItems *>*list;//这几天的详细数据
...
@end
@interface JGJNoPayAmount : CommonModel
@property (nonatomic, copy) NSString *balance_amount;//未接金额
@property (nonatomic, copy) NSString *un_salary_tpl;//有多少比未设置薪资
@property (nonatomic, copy) NSString *salary_desc;//未设置模板金额描述
@property (nonatomic, copy) NSString *bill_num;//对方已记账笔数
@property (nonatomic, copy) NSString *bill_desc;//对方已记账描述
