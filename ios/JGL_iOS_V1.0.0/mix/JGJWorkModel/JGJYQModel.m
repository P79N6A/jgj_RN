...
@end
@implementation JGJSurePoorBillModel

+(NSDictionary *)mj_objectClassInArray
{
    return @{@"list":@"JGJPoorBillListDetailModel"};
}

@end
@implementation JGJPoorBillListDetailModel
+(NSDictionary *)mj_objectClassInArray
{
    return @{@"set_tpl":@"JGJPoorBillTplModel"};
}



@end
@implementation JGJPoorBillTplModel

@end
@implementation JGJDayCheckingModel



@end
@implementation JGJRecordWorkpointsModel
- (instancetype)init
{
    self = [super init];
    if (self) {
...
+(NSDictionary *)mj_objectClassInArray
{
    return @{@"workday":@"JGJRecordWorkpointsDayModel"};
}
@end
@implementation JGJRecordWorkpointsDayModel
+(NSDictionary *)mj_objectClassInArray
{
    return @{@"list":@"MateWorkitemsItems"};
}
