...
+(void)showadverTiseMentWithImageUrl:(NSString *)url withImage:(UIImage *)image forType:(JGJadverTisenmentType)type andtapImageBlock:(didslectActionBlock)tapYes
{
    ...
    JGJAdvertisementShowView *advretisement = [[[NSBundle mainBundle]loadNibNamed:@"JGJAdvertisementShowView" owner:nil options:nil]firstObject];
    ...
    [advretisement setFrame:CGRectMake(0, 0, TYGetUIScreenWidth, TYGetUIScreenHeight)];
