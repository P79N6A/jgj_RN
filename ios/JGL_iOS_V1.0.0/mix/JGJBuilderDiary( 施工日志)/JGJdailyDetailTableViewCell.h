...
//-(void)selectWeatherAm:(NSString *)am_weather;//选择上午天气
//-(void)selectWeatherpm:(NSString *)pm_weather;//选择下午天气
//-(void)selectTempAm:(NSString *)am_temp;//选择上午温度
//-(void)selectTempPm:(NSString *)pm_temp;//选择下午温度
//-(void)selectWindAm:(NSString *)am_wind;//选择上午风力
//-(void)selectWindPm:(NSString *)Pm_wind;//选择下午风力
-(void)clicKRecordWeatherlableAndtag:(NSInteger)tag;
