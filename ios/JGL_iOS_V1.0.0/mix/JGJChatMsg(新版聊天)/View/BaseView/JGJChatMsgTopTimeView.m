...
-(void)setJgjChatListModel:(JGJChatMsgListModel *)jgjChatListModel {
    ...
    if (jgjChatListModel.msg_total_type == JGJChatNormalMsgType) {// 普通聊天消息
        ...
        }else if (jgjChatListModel.chatListType == JGJChatListOssType) {// 日志
