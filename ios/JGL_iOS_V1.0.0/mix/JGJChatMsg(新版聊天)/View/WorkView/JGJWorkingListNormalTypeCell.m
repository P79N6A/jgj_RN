...
- (void)subClassSetWithModel:(JGJChatMsgListModel *)jgjChatListModel{
    ...
    if (jgjChatListModel.chatListType == JGJChatListIntegralType || jgjChatListModel.chatListType == JGJChatListPostCensorType) {// 积分推送 或者 帖子违规操作推送
    ...
    if (jgjChatListModel.chatListType == JGJChatListRemoveType || jgjChatListModel.chatListType == JGJChatListCloseType || jgjChatListModel.chatListType == JGJChatListDismissGroupType || jgjChatListModel.chatListType == JGJChatListPostCensorType) {
        
        _detailViewHeight.constant = 0;
        _lookDetailView.hidden = YES;

        
    }else if (jgjChatListModel.chatListType == JGJChatListUnKonownMsgType) {
        
        _detailViewHeight.constant = 0;
        _lookDetailView.hidden = YES;
        _content.textColor = AppFont666666Color;
        ...
        }else if (jgjChatListModel.chatListType == JGJChatListIntegralType || jgjChatListModel.chatListType == JGJChatListEvaluateType || jgjChatListModel.chatListType == JGJChatListJoinType || jgjChatListModel.chatListType == JGJChatListReopenType || jgjChatListModel.chatListType == JGJChatListSwitchgroupType) {
