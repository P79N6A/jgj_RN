...
{
    if (!_topLable) {
        _topLable = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, TYGetUIScreenWidth, 0)];
...
//        _peopleCollectionview =[[UICollectionView alloc]initWithFrame:CGRectMake(0, 0,ScreenSize.width, ScreenSize.height-60-120) collectionViewLayout:layout];
        _peopleCollectionview =[[UICollectionView alloc]initWithFrame:CGRectMake(0, 0,ScreenSize.width, CGRectGetMinY(self.JoinGrounpButton.frame)) collectionViewLayout:layout];
...
-(UIButton *)JoinGrounpButton
{
    if (!_JoinGrounpButton) {
        ...
        _JoinGrounpButton = [[UIButton alloc]initWithFrame:CGRectMake(7.5, ScreenSize.height - 250 - JGJ_IphoneX_BarHeight, ScreenSize.width-15, 45.5)];
        _JoinGrounpButton.layer.cornerRadius = 5;
        _JoinGrounpButton.layer.masksToBounds = YES;
        _JoinGrounpButton.backgroundColor = RGB_COLOR(202, 15, 33);
...
-(void)waitAnimal
{
    ...
    imageview.animationImages=@[[UIImage imageNamed:@"new_feature_1.jpg"],[UIImage imageNamed:@"new_feature_2.jpg"],[UIImage imageNamed:@"new_feature_3.jpg"]];
