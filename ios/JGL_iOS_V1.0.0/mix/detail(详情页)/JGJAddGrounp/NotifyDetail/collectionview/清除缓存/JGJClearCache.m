...
//    }
    ...
    NSString *ChatList = [[NSHomeDirectory() stringByAppendingPathComponent:@"Documents/chatdatabase/"] stringByAppendingPathComponent:@"jgj_chat_msg.db"];
...
- (float)checkTmpSize
{
   ...
   clearNum =[self datalenthFromPath:audioStr];
    ...
    return clearNum+Num + pdfData + wordclearNum;
