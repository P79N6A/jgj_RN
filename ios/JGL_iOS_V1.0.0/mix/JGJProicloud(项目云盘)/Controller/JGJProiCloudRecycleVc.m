...
- (void)commonInit{
    ...
    self.selButton.titleLabel.font = [UIFont systemFontOfSize:JGJNavBarFont];
    
    [self.selButton setTitleColor:JGJMainColor forState:UIControlStateNormal];
    
    self.cancelButton.titleLabel.font = [UIFont systemFontOfSize:JGJNavBarFont];
    
    [self.cancelButton setTitleColor:JGJMainColor forState:UIControlStateNormal];
    
    self.allCancelButton.titleLabel.font = [UIFont systemFontOfSize:JGJNavBarFont];
    
    [self.allCancelButton setTitleColor:JGJMainColor forState:UIControlStateNormal];
...
- (void)setAllCancelButton {
    ...
    [cancelButton setTitleColor:JGJMainColor forState:UIControlStateNormal];
