...
- (void)webSocketDidOpen:(SRWebSocket *)webSocket{
    ...
    //重连到打开拉取离线消息 2.5.0去掉socket断开到打开拉取离线消息
...
-(NSString *)socketUrl{
    ...
    NSString *socketUrl = [NSString stringWithFormat:@"token=%@&os=I&client_type=person&ver=%@",socketUserTokenStr ?:@"",socketShorverStr];
