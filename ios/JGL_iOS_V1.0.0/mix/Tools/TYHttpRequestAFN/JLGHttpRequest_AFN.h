...
//ifndef 运行就是开发测试环境，打包出去是正式环境，ifdef 运行就是正式环境，打包出去是开发测试环境
#ifndef DEBUG
...
#define JGJWebDomainURL             @"nm.jgjapp.com" //发现3.0.0-判断H5域名用于判断是内部地址还是外部地址
...
#define JGJWebDiscoverURL           @"http://nm.beta.jgjapp.com/" //发现2.1.0-yj
...
//#define JGJ_WebSocket_IP            @"ws://ws.test.jgjapp.com/websocket"
//#define JLGHttpRequest_WX2          @"http://wx2.test.jgjapp.com/"
//#define JGJWebDiscoverURL           @"http://nm.test.jgjapp.com/" //发现2.1.0-yj
//#define JLGHttpRequest_IP_center    @"http://test.cdn.jgjapp.com/" //中心裁剪
//#define JGJWebDomainURL           @"nm.test.jgjapp.com" //发现3.0.0-判断H5域名用于判断是内部地址还是外部地址
...
#define JGJWebDiscoverURL           @"http://nm.ex.yzgong.com/" //发现2.1.0-yj
#define JLGHttpRequest_IP_center           @"http://ex.cdn.yzgong.com/" //中心裁剪

#define JGJWebDomainURL           @"nm.ex.yzgong.com" //发现3.0.0-判断H5域名用于判断是内部地址还是外部地址
...
//头像的地址，通用的
#define JLGHttpRequest_UserHead     [JLGHttpRequest_IP stringByAppendingString:@"2/index/userhead?uid="]
