...
- (void)setSubViewFrame {
    ...
    [self setImage:[UIImage imageNamed:@"barButtonItem_back"] forState:UIControlStateNormal];
    
    [self setImage:[UIImage imageNamed:@"barButtonItem_back_L"] forState:UIControlStateHighlighted];
    ...
    [self setTitleColor:JGJMainColor forState:UIControlStateNormal];
    
    [self setTitleColor:JGJBackHightColor forState:UIControlStateHighlighted];
