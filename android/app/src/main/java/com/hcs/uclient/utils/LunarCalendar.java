...
public class LunarCalendar {
    ...
    public static final int[] lunarToSolar(int year, int month, int monthDay,
        ...
        solarInfo[0] = year;
//        Log.e("leapMonth----22---------", solarInfo[0] + "年" + solarInfo[1] + "月" + solarInfo[2] + "日" + ",,,,");
...
//    }
     ...
     * @return true 大月、 小月
     */
    public static String getLargeOrSmallMonth(int month) {
        int[] data = new int[]{1, 3, 5, 7, 8, 10, 12};
...
//            }
    ...
    public static List<String> getSc() {
        String[] sc = new String[]{"子", "丑", "寅", "卯", "辰", "巳", "午", "未", "申", "酉", "辛", "亥"};
