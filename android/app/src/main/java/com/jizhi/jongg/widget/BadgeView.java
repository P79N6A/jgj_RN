...
public class BadgeView extends TextView {
    ...
    public BadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.BadgeView, defStyle, 0);
        DEFAULT_LR_PADDING_DIP = a.getDimensionPixelSize(R.styleable.BadgeView_paddingSize, DEFAULT_LR_PADDING_DIP);
        a.recycle();
...
//        }
    ...
    private void applyRelativeLayoutParams() {
    ...
    private void applyLinearLayoutParams() {
        badgePosition = POSITION_CENTER;
