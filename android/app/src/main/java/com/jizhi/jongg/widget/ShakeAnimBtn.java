...
public class ShakeAnimBtn extends ImageView {


    public ShakeAnimBtn(Context context) {
        super(context);
    }

    public ShakeAnimBtn(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                setImageResource(R.drawable.create_btn_press);
                startActionDownAnim();
                break;
            case MotionEvent.ACTION_UP:
                setImageResource(R.drawable.create_btn_normal);
                stopShakeAnim();
                break;
        }
