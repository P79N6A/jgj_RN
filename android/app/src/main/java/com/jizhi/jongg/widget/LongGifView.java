...
public class LongGifView extends View {
    ...
    public LongGifView(Context context) {
        this(context, null);
    }
    ...
    public LongGifView(Context context, AttributeSet attrs) {
        this(context, attrs, R.styleable.CustomTheme_gifViewStyle);
    }

    public LongGifView(Context context, AttributeSet attrs, int defStyle) {
