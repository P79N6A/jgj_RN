    ...
    private void setTextViewsTrue(List<String> dataList) {
        ...
        for (int i = 0; i < dataList.size(); i++) {
            ...
            if (!TextUtils.isEmpty(dataList.get(i))) {
                ...
                if (dataList.get(i).toString().equals("吉")) {
                    tv.setTextColor(context.getResources().getColor(R.color.green_288a48));
                } else if (dataList.get(i).toString().equals("凶")) {
                    tv.setTextColor(context.getResources().getColor(R.color.app_color_pressed));
                } else {
