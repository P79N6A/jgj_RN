...
public class FlowRadioGroup extends LinearLayout {  
            ...
            child.setOnTouchListener(new OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    if (mOnCheckedChangeListener != null) {
                        mOnCheckedChangeListener.onCheckedChanged(FlowRadioGroup.this, child.getId());
                    }
                    return true;
                }
            });  
                ...
                if (view instanceof RadioButton) {  
                    ...
                    button.setOnTouchListener(new OnTouchListener() {
                        ...
                        public boolean onTouch(View v, MotionEvent event) {
                            ...
                            if (mOnCheckedChangeListener != null) {
                                mOnCheckedChangeListener.onCheckedChanged(FlowRadioGroup.this, button.getId());
                            }
                            return true;
                        }
                    });  
    ...
    /** 
     * <p> a callback to be invoked when the checked radio button
