...
public class SWImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    private void inital(Context context, AttributeSet attrs) {
        ...
        borderRadius = dp2px(array.getDimension(R.styleable.SWImageView_siv_borderRadius, BODER_RADIUS_DEFAULT));
        type = array.getInt(R.styleable.SWImageView_siv_type, TYPE_NORMAL);
        border_width = dp2px(array.getDimension(R.styleable.SWImageView_siv_borderWidth, BORDER_WIDTH));
        border_width = 2;
        border_color = array.getInt(R.styleable.SWImageView_siv_borderColor, BORDER_COLOR);
        array.recycle();
    }
