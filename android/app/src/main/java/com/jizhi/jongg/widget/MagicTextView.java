...
public class MagicTextView extends TextView {
    ...
    /* 宽高是否相等 */
    private boolean isWidthEqulsHeight;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (isWidthEqulsHeight) {
            int width = DensityUtils.getScreenWidth(getContext()) / 3;
            int height = width / 2;
    ...
    public void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            isWidthEqulsHeight = a.getBoolean(R.styleable.MagicTextView_isWidthEqulsHeight, false);
            String typefaceName = a.getString(R.styleable.MagicTextView_typefaces);
...
//            }
            ...
            if (a.hasValue(R.styleable.MagicTextView_outerShadowColor)) {
                this.addOuterShadow(a.getFloat(
                        R.styleable.MagicTextView_outerShadowRadius, 0), a.getFloat(R.styleable.MagicTextView_outerShadowDx, 0),
