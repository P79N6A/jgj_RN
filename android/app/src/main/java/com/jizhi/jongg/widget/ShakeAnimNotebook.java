...
public class ShakeAnimNotebook extends ImageView {


    public ShakeAnimNotebook(Context context) {
        super(context);
    }

    public ShakeAnimNotebook(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                setImageResource(R.drawable.send_btn_press);
                startActionDownAnim();
                break;
