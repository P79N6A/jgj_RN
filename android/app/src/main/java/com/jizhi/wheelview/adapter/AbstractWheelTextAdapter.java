...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
     ...
     * 选中字体大小
     */
    public static int CHOOSE_TEXT_SIZE = 20;
    /**
     * 未选中字体大小
     */
    public static int UNCHOOSE_TEXT_SIZE = 14;
    ...
    protected AbstractWheelTextAdapter(Context context, int itemResource) {
        this(context, itemResource, NO_RESOURCE, 0, CHOOSE_TEXT_SIZE, UNCHOOSE_TEXT_SIZE);
    }
    ...
    protected AbstractWheelTextAdapter(Context context, int itemResource, int itemTextResource, int currentIndex, int maxsize, int minsize) {
        ...
        this.CHOOSE_TEXT_SIZE = maxsize;
        this.UNCHOOSE_TEXT_SIZE = minsize;
        ...
        if (index >= 0 && index < getItemsCount()) {
            ...
            if (textView != null) {
                ...
                if (index == currentIndex) {
                    textView.setTextSize(CHOOSE_TEXT_SIZE);
                    textView.setTextColor(context.getResources().getColor(R.color.app_color));
                } else {
                    textView.setTextSize(UNCHOOSE_TEXT_SIZE);
