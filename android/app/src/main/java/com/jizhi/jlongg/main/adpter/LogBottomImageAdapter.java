 ...
 * 作者:xuj
 */
public class LogBottomImageAdapter extends BaseAdapter {
    ...
    public LogBottomImageAdapter(Context context, OnSquaredImageRemoveClick listener, List<ImageItem> list, int MAXPHOTOCOUNT, ClickListener clickListener) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        switch (type) {
            case TYPE_ADD:
                ...
                convertView.findViewById(R.id.add_layout).setOnClickListener(new View.OnClickListener() {
                    @Override
