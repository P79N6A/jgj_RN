...
public class MessageHeader extends BaseHeader {
    ...
    private final int ROTATE_ANIM_DURATION = 120;
...
//        this(context, R.drawable.progress_small, R.drawable.arrow);
    ...
    public MessageHeader(Context context, int rotationSrc, int arrowSrc) {
