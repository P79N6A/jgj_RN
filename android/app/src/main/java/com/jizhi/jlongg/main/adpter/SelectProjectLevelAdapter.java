 ...
 */
public class SelectProjectLevelAdapter extends BaseAdapter {
    ...
    public SelectProjectLevelAdapter(BaseActivity context, List<ProjectLevel> list) {
        super();
        this.list = list;
     ...
     * @param list
     */
    public void updateListView(List<ProjectLevel> list) {
        this.list = list;
