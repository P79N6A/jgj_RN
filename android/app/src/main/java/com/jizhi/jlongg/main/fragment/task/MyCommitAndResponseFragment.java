 ...
 * 作者:Xuj
 */
public class MyCommitAndResponseFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        taskStatus = getArguments().getString("taskStatus");
    ...
    public void getData() {
        ...
        params.addBodyParameter("task_type", taskStatus);  //任务类型（1:我负责的，2：我发布的）
