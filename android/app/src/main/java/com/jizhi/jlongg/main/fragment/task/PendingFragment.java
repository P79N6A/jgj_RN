...
public class PendingFragment extends Fragment {
    ...
    public void getData() {
        ...
        params.addBodyParameter("task_status", "0"); //	任务状态(0:待处理，1：已完成 , 2:全部)
            ...
            public void onSuccess(ResponseInfo<String> responseInfo) {
                try {
                    ...
                    if (base.getState() != 0) {
                        ...
                        AllTaskNewActivity.fillUnDailCount(base.getValues().getUn_deal_count(), base.getValues().getComplete_count()); //填充未读消息数
                        if (list.size() > 0) {
                            if (adapter == null) {
