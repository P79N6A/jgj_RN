 ...
 */
public class MessageSignAdapter extends BaseExpandableListAdapter {
    ...
    public MessageSignAdapter(Context context, List<Sign> messageBillData, int is_creater, SignChildClickLisener SignChildClickLisener) {
...
//        getCalculateSize();
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        holder.tv_count.setText(Html.fromHtml("<font color=red>" + mbData.getSign_num() + "</font>人已签到"));
//        if (is_creater == 1) {
//            holder.tv_count.setText(Html.fromHtml("今日签到<font color=red>" + mbData.getSign_num() + "</font>人"));
//        } else {
//            holder.tv_count.setText(Html.fromHtml("今日签到<font color=red>" + mbData.getSign_num() + "</font>次"));
//        }
...
//        Picasso.with(context).load(NetWorkRequest.IP_ADDRESS + mbData.getHead_pic()).placeholder(R.drawable.friend_head).error(R.drawable.friend_head).into(childHolder.img_head);
        childHolder.img_head.setView( mbData.getHead_pic(),mbData.getGroup_user_name(),0);
