 ...
 * 作者:xuj
 */
public class RecordContactsAdatper extends PersonBaseAdapter {
    /**
     * 列表数据
     */
    ...
    public RecordContactsAdatper(Context context, List<PersonBean> list, AddSynchPersonListener listener) {
        super();
        this.list = list;
    ...
    private void bingData(ViewHolder holder, final int position) {
        ...
        holder.addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (listener != null) {
                    listener.add(bean.getName(), bean.getTelph(), null, position);
                }
            }
        });
    }
