...
public class CalendarUtils {
    ...
    public CalendarModel getDays() {
        CalendarModel CalendarModel = new CalendarModel();
        CalendarModel.setLunarCalendarYear(mLuchYear+"");
        CalendarModel.setLunarCalendarMonth(CHINESE_NUMBER[mLuchMonth - 1]);
        CalendarModel.setLunarCalendarDate(getChinaDayString(mLuchDay));
