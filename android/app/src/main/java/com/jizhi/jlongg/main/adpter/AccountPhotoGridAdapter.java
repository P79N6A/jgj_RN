 ...
 * 作者:xuj
 */
public class AccountPhotoGridAdapter extends BaseAdapter {
    /**
     * gridView 图片列表
     */
    ...
    public AccountPhotoGridAdapter(Activity context, List<ImageItem> imageItems, PhotoDeleteListener listener) {
        this.context = context;
        this.imageItems = imageItems;
        this.listener = listener;
        inflater = LayoutInflater.from(context);
    }
    public AccountPhotoGridAdapter(Activity context, List<ImageItem> imageItems, PhotoDeleteListener listener, int max) {
        this.context = context;
        this.imageItems = imageItems;
        this.listener = listener;
        this.max = max;
