...
//		setActiveMonth(mUnit.getTo());
	...
	public int getWeekOfMonth() {
		if (mUnit.isInView(mSelected)) {
			...
			return mUnit.getFirstWeek(mUnit
					.getFirstDateOfCurrentMonth(mActiveMonth)); // if not in
																// this month
																// first week
																// should be
																// selected
