 ...
 */
public class RegisterTimerTextView extends CountDownTimer {
    /**
     * 按钮
     */
    ...
    public RegisterTimerTextView(long millisInFuture, long countDownInterval, TextView btn, Resources res) {
