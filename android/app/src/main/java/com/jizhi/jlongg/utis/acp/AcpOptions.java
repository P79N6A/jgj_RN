package com.jizhi.jlongg.utis.acp;
...
public final class AcpOptions {
    ...
    public static class Builder {
        private static final String DEF_RATIONAL_MESSAGE = "此功能需要你授权，否则将不能正常使用";
        private static final String DEF_DENIED_MESSAGE = "你拒绝权限申请，此功能将不能正常使用，你可以去设置页面重新授权";
