...
import com.jizhi.jlongg.main.activity.SynchProjectListActivity;
...
/**
 * 功能:同步项目
 * 时间:2017年6月19日10:31:43
 * 作者:xuj
 */
public class SyncManageAdapter extends PersonBaseAdapter {
    /**
     * 列表数据
     */
    ...
    public SyncManageAdapter(Activity context, List<SynBill> list) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_synchronous_bills, null);
        ...
        if (TextUtils.isEmpty(descript)) {
            ...
            holder.pro_name.setText(null);
        } else {
            holder.line.setVisibility(View.VISIBLE);
            holder.pro_name.setText(bean.getDescript());
        }
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, SynchProjectListActivity.class);
                intent.putExtra(Constance.BEAN_CONSTANCE, bean);
                intent.putExtra(Constance.BEAN_BOOLEAN, false); //true 针对项目  false 针对人
                context.startActivityForResult(intent, Constance.REQUEST_ADD);
            }
        });
        return convertView;
    }
    ...
    class ViewHolder {
        public ViewHolder(View convertView) {
            ...
            guideImage = (ImageView) convertView.findViewById(R.id.guide_image);
