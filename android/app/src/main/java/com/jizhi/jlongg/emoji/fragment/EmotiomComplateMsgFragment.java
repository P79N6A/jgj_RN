...
import com.jizhi.jlongg.emoji.adapter.EmotionGridViewAdapter;
import com.jizhi.jlongg.emoji.adapter.EmotionPagerAdapter;
import com.jizhi.jlongg.emoji.emotionkeyboard.EmojiIndicatorView;
import com.jizhi.jlongg.emoji.utils.DisplayUtils;
 ...
 */
public class EmotiomComplateMsgFragment extends BaseFragment {
    ...
    private void initEmotion() {
        ...
        List<String> tempEmoji = Arrays.asList(EmotionUtils.getEmojis(getActivity()));
        if (null == tempEmoji) {
            return;
        }
        List<GridView> emotionViews = new ArrayList<>();
        List<String> emotionNames = new ArrayList<>();
        for (String emojiName : tempEmoji) {
...
//        gv.setVerticalSpacing(padding * 2);
        ...
        //设置全局点击事件
        gv.setOnItemClickListener(GlobalOnItemClickManagerMsgUtils.getInstance(getActivity()).getOnItemClickListener(emotion_map_type));
        return gv;
    }
