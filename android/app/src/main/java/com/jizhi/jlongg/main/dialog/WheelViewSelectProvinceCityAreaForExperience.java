...
import com.jizhi.jlongg.main.listener.SelectProvinceCityAreaForExperienceListener;
...
public class WheelViewSelectProvinceCityAreaForExperience extends PopupWindow implements OnClickListener, OnWheelChangedListener, OnWheelScrollListener, PopupWindow.OnDismissListener {
    /* 省wheelView  */
    ...
    /* 选择省、市、县回调 */
    public SelectProvinceCityAreaForExperienceListener listener;
    /* 上下文 */
    ...
    * */
    ...
    public WheelViewSelectProvinceCityAreaForExperience(Activity context, SelectProvinceCityAreaForExperienceListener listener, String title, String type) {
        super(context);
        ...
        switch (v.getId()) {
            case R.id.btn_confirm:
                ...
                if (cityList != null && cityList.size() > 0) {
                    ...
                    searchName = cityList.get(cityPosition).getCity_name();
                }
                ...
                listener.selectedCityResult(type, cityCode, builder.toString(), searchName);
                break;
        }
        dismiss();
    }
