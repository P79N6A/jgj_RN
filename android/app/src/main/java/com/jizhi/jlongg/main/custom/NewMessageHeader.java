...
//
//public class NewMessageHeader extends BaseHeader {
...
//
//    public NewMessageHeader(Context context) {
//        this(context, R.drawable.progress_small, R.drawable.arrow);
//    }
//
//    public NewMessageHeader(Context context, int rotationSrc, int arrowSrc) {
...
//        View view = inflater.inflate(R.layout.layout_custom_progress, viewGroup, true);
