 ...
 * 本人仅做细微修改以及代码解析
 */
public class EmotionKeyboardMsg {
     ...
     * @return
     */
    public static EmotionKeyboardMsg with(Activity activity) {
        EmotionKeyboardMsg emotionInputDetector = new EmotionKeyboardMsg();
     ...
     * @return
     */
    public EmotionKeyboardMsg bindToContent(View contentView) {
     ...
     * @return
     */
    public EmotionKeyboardMsg bindToEditText(EditText editText) {
        mEditText = editText;
     ...
     * @return
     */
    public EmotionKeyboardMsg bindToEmotionButton(final View emotionButton) {
    ...
    public EmotionKeyboardMsg bindToLayoutView(View contentView) {
     ...
     * @return
     */
    public EmotionKeyboardMsg setEmotionView(View emotionView) {
        mEmotionLayout = emotionView;
        return this;
    }

    public EmotionKeyboardMsg build() {
    ...
    private int getSupportSoftInputHeight() {
        ...
        LUtils.e(screenHeight + "-----22----"+softInputHeight+"---A--------" + r.bottom);
        ...
        if (softInputHeight < 0) {
            LUtils.e("--22----EmotionKeyboard--Warning: value of softInputHeight is below zero!");
            softInputHeight=0;
        }
        //存一份到本地
        if (softInputHeight > 0) {
