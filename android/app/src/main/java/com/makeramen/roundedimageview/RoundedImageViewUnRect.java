...
public class RoundedImageViewUnRect extends ImageView {
    ...
    private boolean clickAlpha = false;
    ...
    public RoundedImageViewUnRect(Context context) {
        super(context);
    }

    public RoundedImageViewUnRect(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundedImageViewUnRect(Context context, AttributeSet attrs, int defStyle) {
        ...
        float cornerRadiusOverride = a.getDimensionPixelSize(R.styleable.RoundedImageView_riv_corner_radius, (int) context.getResources().getDimension(R.dimen.rect_radius));
        ...
        clickAlpha = a.getBoolean(R.styleable.RoundedImageView_riv_click_alpha, false);
