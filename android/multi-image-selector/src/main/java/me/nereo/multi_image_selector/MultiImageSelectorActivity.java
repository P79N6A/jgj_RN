...
public class MultiImageSelectorActivity extends FragmentActivity implements MultiImageSelectorFragment.Callback {
     ...
     * 拍照的时候返回路径
     */
    public static final String EXTRA_CAMERA_FINISH = "finish_camera";
    /**
    ...
    public static final int RESULTCODE_CAERA_FINISH = 0X44;
    ...
    public void onCameraShot(File imageFile) {
        if (imageFile != null) {
            ...
            data.putStringArrayListExtra(EXTRA_RESULT, resultList);
            data.putExtra(MultiImageSelectorActivity.EXTRA_CAMERA_FINISH, imageFile.getAbsolutePath());
            setResult(RESULT_OK, data);
            finish();
        }
    }
