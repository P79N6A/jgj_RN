...
public class NiceVideoPlayer extends FrameLayout
    ...
    private TxVideoPlayerController.MediaPlayerListener mediaPlayerListener;
    ...
    public void start() {
        if (mCurrentState == STATE_IDLE) {
            ...
            if (mediaPlayerListener != null) {
                mediaPlayerListener.startVideoCallBack();
            }
        } else {
...
//                    ((IjkMediaPlayer)mMediaPlayer).setOption(4, "framedrop", 1L);
    ...
    public TxVideoPlayerController.MediaPlayerListener getMediaPlayerListener() {
        return mediaPlayerListener;
    }

    public void setMediaPlayerListener(TxVideoPlayerController.MediaPlayerListener mediaPlayerListener) {
